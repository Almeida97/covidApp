...
class FlagViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(country.name)
        cell.countryImage?.loadFrom(URLAddress: "https://countryflagsapi.com/png/\(country.iso2)")
//        cell.countryImage.sd_setImage(with: URL(string: "https://countryflagsapi.com/png/\(country.name)"), placeholderImage: UIImage(named: "placeholder.png"))
